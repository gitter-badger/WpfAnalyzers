...
//            var defaultValue = fieldDeclaration.DependencyPropertyRegisteredDefaultValue(context.SemanticModel);
...
//            //context.SemanticModel.ClassifyConversion(defaultValue, context.SemanticModel.GetTypeInfo(type).Type);
